...
router.route("/").get(adminController.mainAdmin);
/* +++++++++++++++++++++++++++++++++++++++ Category ++++++++++++++++++++++++++++++++++++++++++++++ */
router.route("/categorys").get(adminController.GetReadCategory);
...
/* +++++++++++++++++++++++++++++++++++++++ Worker ++++++++++++++++++++++++++++++++++++++++++++++ */
router.route("/workers").get(adminController.GetReadWorker);
router
  .route("/workers/add")
